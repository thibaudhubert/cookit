...
import { Search, Heart, MessageCircle, Bookmark, Clock, ChefHat, User } from 'lucide-react'
import { timeAgo } from '@/lib/utils'
import type { Recipe, Profile } from '@/lib/types'

type RecipeWithAuthor = Recipe & { author: Profile }
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg shadow-sm p-12 text-center">
            <p className="text-gray-600">
              {searchQuery ? `No recipes found matching "${searchQuery}"` : 'No recipes yet!'}
            </p>
          </div>
        ) : (
          <>
